...
public class PhotoActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_talk_show_pic);
        ...
        Button photo_bt_exit = (Button)findViewById(R.id.photo_bt_cancel);
        ...
        Button photo_bt_enter = (Button)findViewById(R.id.photo_bt_confirm);
